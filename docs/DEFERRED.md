...
| DEF-003 | Desktop/Web UI QA rows (visual single pill, switch-agent and edit-during-request in the live UI, theme) have no browser evidence: no seat in the room has the MultiZen MCP client | 2026-09-21 | DLF-008 / pk-UkLWZ.4 | Human opens a browser-QA batch; MultiZen profile 20def08f-9a62-4932-9d49-f7c5ab12c6d0 is now reachable from the Lead runtime | OPEN |
